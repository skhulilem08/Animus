...
**How to apply:** Build native-first with Iconoir controls, Apple system typography on iOS, and Plus Jakarta Sans on Android. Use Liquid Glass for the Home header and icon-only bottom tabs. Keep the bottom bar fixed. Its indicator sits behind sharp icons, rests with an opaque current-community undertone, becomes clear blurred glass with a subtle gel stretch during horizontal drag and snap, then restores the tint after settling. It snaps to the nearest tab and spring-slides on taps. Use translucent blur fallbacks where native glass is unavailable. Resolve visual ambiguity in favor of the PNG and behavioral ambiguity in favor of the MD.