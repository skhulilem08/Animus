...
**How to apply:** Build native-first with Iconoir controls, Apple system typography on iOS, and Plus Jakarta Sans on Android. Use Liquid Glass for the Home header and icon-only bottom tabs. Keep the bottom bar fixed; its clear glass indicator sits behind sharp icons, follows horizontal drags, snaps to the nearest tab, and spring-slides on taps. Use translucent blur fallbacks where native glass is unavailable. Resolve visual ambiguity in favor of the PNG and behavioral ambiguity in favor of the MD.