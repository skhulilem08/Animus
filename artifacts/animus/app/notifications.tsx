...
import { EmptyState, ErrorState, Header, LoadingState, Screen, relativeTime } from '@/components/AnimusUI';

const iconFor = (kind: string): keyof typeof Feather.glyphMap => ({ like: 'heart', comment: 'message-circle', follow: 'user-plus', live: 'radio', message: 'mail', community: 'hash' }[kind] as keyof typeof Feather.glyphMap || 'bell');
